...
export function useQueryParams() {
  return useMemo(() => {
    ...
    const sample = {
      ...
      assignedTherapistQaulification:
    ...
    return {
      ...
      assignedTherapistQaulification: getParam(
        "assignedTherapistQaulification",
      ),
      assignedCommManager: getParam("assignedCommManager"),
      pricing: Number(getParam("pricing")),
      planDetails: decodeURIComponent(params.get("planDetails") ?? ""),
      planCreatedBy,
